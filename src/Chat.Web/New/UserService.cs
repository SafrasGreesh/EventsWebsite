...
namespace EventsWebsites.New
{
    ...
    public UserService(IEfRepository<ApplicationUser> userRepository, IConfiguration configuration, IMapper mapper, IEfRepository<Options> optionsRepository, IEfRepository<Likes> likesRepository, IEfRepository<Matches> matchesRepository)
    {
